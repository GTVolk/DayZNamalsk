...
//Add skin item
[_body] call fn_addClothesForDeadBody;
...
if (!local _source && isPlayer _source) then {
	...
	_punishment = (_isBandit or {_body getVariable ["OpenTarget",false]} or {typeOf _body in ["Sniper1_DZ","Sniper1W_DZN","CamoWinter_DZN", "CamoWinterW_DZN","Soldier1_DZ","Camo1_DZ"]});
	_humanityHit = 0;
